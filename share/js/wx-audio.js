(function (window, document) {
	...
	Wxaudio.prototype = {
		...
		initDom: function () {
			...
			// left image
			this.wxAudioStatediv = document.createElement('div')
			this.wxAudioStatediv.className = 'wx-audio-state'
			this.wxAudioStatediv.style.backgroundImage  = 'url(../images/off.png)'
			this.wxAudioL.appendChild(this.wxAudioStatediv)
		...
		initAudioEvent: function () {
			...
			_this.wxAudio.onplaying = function () {
				...
				_this.wxAudioStatediv.style.backgroundImage = 'url(../images/play.png)'
			},
			_this.wxAudio.onpause = function () {
				_this.isPlaying = false
				_this.showLoading(false)
				_this.wxAudioStatediv.style.backgroundImage = 'url(../images/off.png)'
			},
			...
			// 页面点击事件
			_this.wxAudioStatediv.onclick = function () {
