...
$(document).ready(function() {
  $.ajax({
    type: "post",
    url: "/v1/circle/dynamic/show", //前缀
    data: { token: "header", dynId: partner },
    dataType: "json",
    success: function(info) {
      console.log(info);
      if (info.data.DynReplyInfo == "") {
        var data = info.data.DynComInfo;
        var Time = timestampToTime(info.data.CreateTime);
        data.Time = Time;
        var startArr = [];
      ...
      $("#xiazai,#xiazai1,#gengduo").click(function() {
